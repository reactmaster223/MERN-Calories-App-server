...
class Food extends React.Component {
    ...
    GetUserRole = () => {
        ...
        fetch(`http://localhost:8080/api/auth/eachuser`, {
            method: 'POST',
            headers: {
    ...
    Getdata = () => {
        console.log(localStorage.getItem('currentUser'))
        fetch(`http://localhost:8080/api/food/getuserdata`, {
            method: 'POST',
            headers: {
              "Content-Type": "application/json"
            },
    ...
    onUpdate = (sendData) => {
        fetch(`http://localhost:8080/api/food/update`, {
            method: 'POST',
            headers: {
              "Content-Type": "application/json"
            },
                                ...
                                <div className='col-3 col-md-4 col-sm-6 col-xs-12 m-3' key = {food._id}>
                                    <Card style={{ width: '18rem' }}>
                                        ...
                                        <Card.Body id={food._id}>
                                            <Card.Title>{food.user_id}</Card.Title>
                                            <Card.Text>
                                            {food.date}
                                            </Card.Text>
