...
class Admin extends React.Component {
    ...
    changeVideoState = (id, stateValue) =>{
        fetch(`http://localhost:8080/api/auth/changeVideoState`, {
            method: 'POST',
            headers: {
    ...
    changeMusicState = (id, stateValue) =>{
        fetch(`http://localhost:8080/api/auth/changeMusicState`, {
            method: 'POST',
            headers: {
              "Content-Type": "application/json"
            },
    ...
    changeFoodState = (id, stateValue) =>{
        fetch(`http://localhost:8080/api/auth/changeFoodState`, {
            method: 'POST',
            headers: {
              "Content-Type": "application/json"
            },
    ...
    deleteUser = (id) =>{
        fetch(`http://localhost:8080/api/auth/deleteuser`, {
            method: 'POST',
            headers: {
              "Content-Type": "application/json"
            },
    ...
    onMusicDelete = (e) => {
        ...
        fetch(`http://localhost:8080/api/music/delete`, {
            method: 'POST',
            headers: {
              "Content-Type": "application/json"
            },
    ...
    onFoodDelete = (e) => {
        console.log(e.target.parentNode.id)
        fetch(`http://localhost:8080/api/food/delete`, {
            method: 'POST',
            headers: {
              "Content-Type": "application/json"
            },
    ...
    onVideoDelete = (e) => {
        console.log(e.target.parentNode.id)
        fetch(`http://localhost:8080/api/video/delete`, {
            method: 'POST',
            headers: {
              "Content-Type": "application/json"
            },
